...
let people = [{"id":1,"first_name":"Nata","last_name":"Dahlen","email":"ndahlen0@addthis.com","gender":"Female","birthDate":"1/26/1995","web":"https://163.com","creditScore":705,"rating":14.18},
...
c.sort(function (a, b) {
  return a.last_name.localeCompare(b.last_name) || a.first_name.localeCompare(b.firstName) || 0;
});

// or, using arrow function syntax...
c.sort((a, b) => {
  return a.lastName.localeCompare(b.last_name) || a.first_name.localeCompare(b.first_name) || 0;
});
